...
class DataTransformation:
    ...
    def imbalance_data_cleaning(self):
        ...
        try:
            logging.info("Entered into imbalance_data_cleaning funct")
            ...
            logging.info(f"Exited the imbalance data_cleaning function and returned imbalamce data {imbalance_data}")
    ...
    def raw_data_cleaning(self):
        ...
        try:
            logging.info("Entered into the raw_data_cleaning func")
    ...
    def concat_dataframe(self):
        ...
        try:
            logging.info("Entered into concat_dataframe funct ")
            ## lets concat both data into single df
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        ...
        try:
            ...
            logging.info("returning the DataTransformtionArtifacts")
