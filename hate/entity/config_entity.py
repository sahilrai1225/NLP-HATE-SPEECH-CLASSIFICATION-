...
from hate.constants import * ## means importing everything
import os
...
class DataIngestionConfig:
    def __init__(self):
        ...
        self.DATA_INGESTION_ARTIFACTS_DIR: str = os.path.join(ARTIFACTS_DIR,TIMESTAMP,DATA_INGESTION_ARTIFACTS_DIR)
...
class ModelEvaluationConfig:
    def __init__(self):
        self.MODEL_EVALUATION_MODEL_DIR:str =os.path.join(ARTIFACTS_DIR,TIMESTAMP,MODEL_EVALUATION_ARTIFACTS_DIR)
