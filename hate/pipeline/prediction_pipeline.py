...
class PredictionPipeline:
    def __init__(self):
        ...
        self.model_path=os.path.join("artifacts","PredictModel") # will download data from gcloud ans dtore in PredictModel
    ...
    def get_model_from_gcloud(self) ->str:
        """
        Method Name :get model_from_gcloud
        Descp       : this method to get best model from google cloud storage
        ...
        try:
            ...
            #logginng the best model from gcp
    ...
    def predict(self,best_model_path,text):
        logging.info("Running the predict funct")
        ...
        try:
            ...
            if pred>0.5:  #threshold can be any
    ...
    def run_pipeline(self,text):
        ...
        try:
            ...
            logging.info("Exited the run_pipeline of PredictionPipeline")
